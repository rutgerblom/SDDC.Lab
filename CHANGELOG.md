...
### Added by Rutger Blom
  ...
  - Added data structure for NSX Advanced Load Balancer licenses to ```licenses_sample.yml```.
...
### Added by Rutger Blom
  ...
  - Please run the following commands on your Ansible controller so that newer and required versions of collections and modules are installed:
