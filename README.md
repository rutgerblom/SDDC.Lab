...
5. When deploying a Federation configuration, the Workload VM Ansible playbook will fail.  As this is the last task in the deployment steps, the Pod(s) have properly deployed, and it's just the Workload VMs that are missing from the deployment.
